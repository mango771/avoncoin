...
static const uint256 hashGenesisBlockOfficial("0x619c8cbf463458c7f62fb8db3221ae123e53551f3f1f6e8ccbaaef97c52f2a3e");
static const uint256 hashGenesisBlockTestNet ("0x619c8cbf463458c7f62fb8db3221ae123e53551f3f1f6e8ccbaaef97c52f2a3e");
...
public:
    ...
    {
        // avoncoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // avoncoin: get transaction coin age
...
public:
    ...
    // avoncoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // avoncoin: entropy bit for stake modifier if chosen by modifier
    ...
    // avoncoin: two types of block: proof-of-work or proof-of-stake
    ...
    // avoncoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // avoncoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // avoncoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // avoncoin: block index flags
    enum
    {
